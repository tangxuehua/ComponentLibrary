...
namespace NetFocus.Components.WebControls
{
    ...
    /// </summary>
    [Editor(typeof(NetFocus.Components.WebControls.Design.ItemCollectionEditor), typeof(UITypeEditor))]
    public abstract class BaseChildNodeCollection : CollectionBase, ICloneable, IStateManager
    {
        ...
        private class Action
        {
            ...
            {
                typeof(NetFocus.Components.WebControls.Tab).AssemblyQualifiedName,
                typeof(NetFocus.Components.WebControls.TabSeparator).AssemblyQualifiedName,
            };
