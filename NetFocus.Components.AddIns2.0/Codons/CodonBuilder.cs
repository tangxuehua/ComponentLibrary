...
namespace NetFocus.Components.AddIns.Codons
{
	...
	public class CodonBuilder
	{
		...
		public CodonBuilder(string className, Assembly assembly)
		{
			...
			CodonTypeAttribute codonTypeAttribute = (CodonTypeAttribute)Attribute.GetCustomAttribute(assembly.GetType(ClassName), typeof(CodonTypeAttribute));
			codonType = codonTypeAttribute.CodonType;
		}
