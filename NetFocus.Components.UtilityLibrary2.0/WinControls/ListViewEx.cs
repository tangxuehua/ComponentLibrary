...
namespace NetFocus.Components.UtilityLibrary.WinControls
{
	...
	public class ListViewEx : ListView
	{
		...
		private void InitializeCheckBoxesImageList()
		{
			...
			Assembly thisAssembly = Assembly.GetAssembly(Type.GetType("NetFocus.Components.UtilityLibrary.WinControls.ListViewEx"));
		...
		private string GetSubItemText(int row, int col)
		{
			...
			lvi.iSubItem = col;
			lvi.cchTextMax = 80;
			lvi.pszText = Marshal.AllocHGlobal(80);
		...
		protected string GetHeaderItemText(int index)
		{
			...
			hdi.cchTextMax =  80;
			hdi.pszText = Marshal.AllocHGlobal(80);
