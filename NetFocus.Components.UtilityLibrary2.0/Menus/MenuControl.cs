...
using NetFocus.Components.UtilityLibrary.Collections;
...
namespace NetFocus.Components.UtilityLibrary.Menus
{
	...
	[Designer(typeof(NetFocus.Components.UtilityLibrary.Menus.MenuControlDesigner))]
	public class MenuControl : ContainerControl, IMessageFilter
	{
		...
		// Class fields
		protected static ImageList _menuImages = new ImageList();
...
//			_menuImages = ResourceUtil.LoadImageListResource(Type.GetType("NetFocus.Components.UtilityLibrary.Menus.MenuControl"),
